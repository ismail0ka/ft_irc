...
{
    std::string nick = _nick.empty() ? std::string("*") : _nick;
    std::string user = _user.empty() ? std::string("unknown") : _user;
    std::string host = _host.empty() ? std::string("localhost") : _host;
